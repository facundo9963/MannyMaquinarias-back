  ...
  up: async (queryInterface, Sequelize) => {
    ...
    const maquinas = await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          ...
          precio: 1200.0,
          imageUrl:
            "https://static.wixstatic.com/media/0f30bf_5ee3454819be4a9db86b2654d72ea4fa~mv2.png/v1/fill/w_480,h_480,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/0f30bf_5ee3454819be4a9db86b2654d72ea4fa~mv2.png",
          sucursal_id: sucursales[0].id,
          politica_cancelacion_id: politicas[1].id,
          createdAt: now,
          updatedAt: now,
        },
        {
          ...
          precio: 800.0,
          imageUrl:
            "https://www.atlascopco.com/content/dam/atlas-copco/construction-technique/construction-tools/pictures/handheld-hydraulic-equipment/hammers-and-breakers/LH%20230%20E.jpg/jcr:content/renditions/cq5dam.web.1200.628.jpeg",
          sucursal_id: sucursales[0].id,
          politica_cancelacion_id: politicas[1].id,
          createdAt: now,
          updatedAt: now,
    ...
    await queryInterface.bulkInsert("reservas", [
      ...
      },
      {
        ...
        fecha_fin: now,
        fecha_reserva: new Date(now.getTime() - 4 * oneDay),
      ...
      {
        precio: 7500.0,
        fecha_inicio: new Date(now.getTime() - 6 * oneDay),
        fecha_fin: new Date(now.getTime() - 1 * oneDay),
        fecha_reserva: new Date(now.getTime() - 7 * oneDay),
