...
const {crearReserva, obtenerReservasPropias, obtenerTodasReservas, historialReservasUsuario, cancelarReserva, eliminarReserva, obtenerReservasPorFecha, crearReservaEmpleado} = require('../controllers/reservaController');
...
router.post('/agregar', verificarToken, verificarTrabajador, crearReservaEmpleado); // Ruta para crear reservas como empleado
